...
GL_FUNCTION(RasterPos3i, void, (GLint x, GLint y, GLint z), (ARG1, ARG2, ARG3),,,("glRasterPos3i"))
...
GL_FUNCTION(Rectdv, void, (const GLdouble *v1, const GLdouble *v2), (marshalArray<GLdouble>(cpu, ARG1, 2), marshalArray<GLdouble>(cpu, ARG2, 2)),,,("glRectdv"))
...
GL_FUNCTION(TexGenf, void, (GLenum coord, GLenum pname, GLfloat param), (ARG1, ARG2, fARG3), , , ("glTexGenf"))
...
GL_FUNCTION(TexImage1D, void, (GLenum target, GLint level, GLint internalFormat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid* pixels), (ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER() ? (GLvoid*)pARG8 : marshalPixels(cpu, 1, ARG4, 1, 1, ARG6, ARG7, ARG8)), , , ("glTexImage1D"))
...
GL_FUNCTION_CUSTOM(ArrayElement, void, (GLint i))
...
GL_FUNCTION(VertexPointer, void, (GLint size, GLenum type, GLsizei stride, const GLvoid* ptr), (ARG1, ARG2, ARG3, marshalVetextPointer(cpu, 0, GL_FALSE, ARG1, ARG2, ARG3, ARG4, false)), , , ("glVertexPointer"))
...
GL_FUNCTION(GetTexGendv, void, (GLenum coord, GLenum pname, GLdouble *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLdouble> buffer(cpu, ARG3, (ARG2 == GL_OBJECT_PLANE || ARG2 == GL_EYE_PLANE) ? 4 : 1);, ,("glGetTexGendv"))
GL_FUNCTION(GetTexGenfv, void, (GLenum coord, GLenum pname, GLfloat *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLfloat> buffer(cpu, ARG3, (ARG2 == GL_OBJECT_PLANE || ARG2 == GL_EYE_PLANE) ? 4: 1);, ,("glGetTexGenfv"))
GL_FUNCTION(GetTexGeniv, void, (GLenum coord, GLenum pname, GLint *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLint> buffer(cpu, ARG3, (ARG2 == GL_OBJECT_PLANE || ARG2 == GL_EYE_PLANE) ? 4 : 1);, ,("glGetTexGeniv"))
GL_FUNCTION(GetTexEnvfv, void, (GLenum target, GLenum pname, GLfloat *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLfloat> buffer(cpu, ARG3, (ARG2 == GL_TEXTURE_ENV_COLOR) ? 4 : 1);, ,("glGetTexEnvfv"))
GL_FUNCTION(GetTexEnviv, void, (GLenum target, GLenum pname, GLint *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLint> buffer(cpu, ARG3, (ARG2 == GL_TEXTURE_ENV_COLOR) ? 4 : 1);, ,("glGetTexEnviv"))
GL_FUNCTION(GetTexParameterfv, void, (GLenum target, GLenum pname, GLfloat *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLfloat> buffer(cpu, ARG3, (ARG2 == GL_TEXTURE_BORDER_COLOR || ARG2 == GL_TEXTURE_SWIZZLE_RGBA) ? 4 : 1);, ,("glGetTexParameterfv"))
GL_FUNCTION(GetTexParameteriv, void, (GLenum target, GLenum pname, GLint *params), (ARG1, ARG2, buffer.getPtr()), MarshalReadWrite<GLint> buffer(cpu, ARG3, (ARG2 == GL_TEXTURE_BORDER_COLOR || ARG2 == GL_TEXTURE_SWIZZLE_RGBA) ? 4 : 1);, ;,("glGetTexParameteriv"))
