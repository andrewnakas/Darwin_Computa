	...
	char const * const aDefaultPath ) /* NULL or "" */
{
	...
	{
		p = inputBox(aTitle, "Select folder","");
	}
...
frontmost of process \\\"Python\\\" to true' ''');");
	...
	else
	{
		...
		{
			gWarningDisplayed = 1 ;
			messageBox ( gTitle , gMessageUnix , "ok", "error" , 1 ) ;
		}
		return NULL ;
	}
