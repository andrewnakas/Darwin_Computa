...
/*0b0*/    {0, 32, 32, 0, 0, 0, 0}, // XchgE32R32
    ...
    {DECODE_BRANCH_NO_CACHE, 0, 1, 0, 0, 0, 0}, // UD2
    ...
    {0, 0, 0, 0, 0, 0}, // Pause
    {0, 64, 64, ZF, 0, 0, 0}, // CmpXchg8b_Lock,
    {0, 32, 32, CF|OF|AF|ZF|SF|PF, 0, 0, 0}, // CmpXchgE32R32_Lock,
    {0, 16, 16, CF|OF|AF|ZF|SF|PF, 0, 0, 0}, // CmpXchgE16R16_Lock,
    {0, 8, 8, CF|OF|AF|ZF|SF|PF, 0, 0, 0}, // CmpXchgE8R8_Lock,
    {0, 8, 8, 0, 0, 0, 0}, // XchgE8R8_Lock,
    {0, 16, 16, 0, 0, 0, 0}, // XchgE16R16_Lock,
    {0, 32, 32, 0, 0, 0, 0}, // XchgE32R32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XaddR8E8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, //     XaddR16E16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XaddR32E32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE8R8_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE8I8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE16R16_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE16I16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE32R32_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AddE32I32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // OrE8R8_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // OrE8I8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // OrE16R16_Lock,
    ...
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AndE16I16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AndE32R32_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // AndE32I32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE8R8_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE8I8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE16R16_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE16I16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE32R32_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // SubE32I32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE8R8_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE8I8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE16R16_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE16I16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE32R32_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // XorE32I32_Lock,
    {0, 8, 8, AF|ZF|SF|OF|PF, 0, 0, 0}, // IncE8_Lock,
    {0, 16, 16, AF|ZF|SF|OF|PF, 0, 0, 0}, // IncE16_Lock,
    {0, 32, 32, AF|ZF|SF|OF|PF, 0, 0, 0}, // IncE32_Lock,
    {0, 8, 8, AF|ZF|SF|OF|PF, 0, 0, 0}, // DecE8_Lock,
    {0, 16, 16, AF|ZF|SF|OF|PF, 0, 0, 0}, // DecE16_Lock,
    {0, 32, 32, AF|ZF|SF|OF|PF, 0, 0, 0}, // DecE32_Lock,
    {0, 8, 8, 0, 0, 0, 0}, // NotE8_Lock,
    {0, 16, 16, 0, 0, 0, 0}, // NotE16_Lock,
    {0, 32, 32, 0, 0, 0, 0}, // NotE32_Lock,
    {0, 8, 8, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // NegE8_Lock,
    {0, 16, 16, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // NegE16_Lock,
    {0, 32, 32, CF|AF|ZF|SF|OF|PF, 0, 0, 0}, // NegE32_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtsE16R16_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtsE16_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtsE32R32_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtsE32_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtrE16R16_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtrE16_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtrE32R32_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtrE32_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtcE16R16_Lock,
    {0, 16, 16, CF, 0, OF|SF|AF|PF, 0}, // BtcE16_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtcE32R32_Lock,
    {0, 32, 32, CF, 0, OF|SF|AF|PF, 0}, // BtcE32_Lock,    
    { 0, 0, 0, 0, 0, 0 }, // None
...
typedef void (*LogFormat)(const LogInstruction* inst, DecodedOp* op, BString& out);
...
static void outXMM(U32 r, BString& out) {
    switch (r) {
    case 0: out.append("xmm0"); break;
    case 1: out.append("xmm1"); break;
    case 2: out.append("xmm2"); break;
    case 3: out.append("xmm3"); break;
    case 4: out.append("xmm4"); break;
    case 5: out.append("xmm5"); break;
    case 6: out.append("xmm6"); break;
    case 7: out.append("xmm7"); break;
    }
}

static void outR32(U32 r, BString& out) {
    switch (r) {
        case 0: out.append("EAX"); break;
        case 1: out.append("ECX"); break;
        case 2: out.append("EDX"); break;
        case 3: out.append("EBX"); break;
        case 4: out.append("ESP"); break;
        case 5: out.append("EBP"); break;
        case 6: out.append("ESI"); break;
        case 7: out.append("EDI"); break;
    }
}

static void outR16(U32 r, BString& out) {
    switch (r) {
        case 0: out.append("AX"); break;
        case 1: out.append("CX"); break;
        case 2: out.append("DX"); break;
        case 3: out.append("BX"); break;
        case 4: out.append("SP"); break;
        case 5: out.append("BP"); break;
        case 6: out.append("SI"); break;
        case 7: out.append("DI"); break;
    }
}

static void outR8(U32 r, BString& out) {
    switch (r) {
        case 0: out.append("AL"); break;
        case 1: out.append("CL"); break;
        case 2: out.append("DL"); break;
        case 3: out.append("BL"); break;
        case 4: out.append("AH"); break;
        case 5: out.append("CH"); break;
        case 6: out.append("DH"); break;
        case 7: out.append("BH"); break;
    }
}

static void outS(U32 s, BString& out) {
    switch (s) {
        case 0: out.append("ES"); break;
        case 1: out.append("CS"); break;
        case 2: out.append("SS"); break;
        case 3: out.append("DS"); break;
        case 4: out.append("FS"); break;
        case 5: out.append("GS"); break;
    }
}

static void outEA32(DecodedOp* op, BString& out) {
    bool added = false;
    ...
    if (op->sibIndex!=8) {
        ...
        outR32(op->sibIndex, out);
        added = true;
        if (op->sibScale!=0) {
            out.append("<<");
            out.append((op->sibScale==1)?"1":"2");
        }
    }
    if (op->data.disp) {
        if (added) {
        ...
        out.append(op->data.disp, 16);
    }
}

static void outEA16(DecodedOp* op, BString& out) {
    bool added = false;
...
static void outE64(DecodedOp* op, BString& out) {
    out.append("QWORD PTR [");
    if (op->ea16)
        outEA16(op, out);
    else
        outEA32(op, out);
...
static void outE32(DecodedOp* op, BString& out) {
    out.append("DWORD PTR [");
    if (op->ea16)
        outEA16(op, out);
    else
        outEA32(op, out);
...
static void outE16(DecodedOp* op, BString& out) {
    out.append("WORD PTR [");
    if (op->ea16)
        outEA16(op, out);
    else
...
static void outE8(DecodedOp* op, BString& out) {
    out.append("BYTE PTR [");
    if (op->ea16)
        outEA16(op, out);
    else
...
static void logRR(const LogInstruction* inst, DecodedOp* op, BString& out) {
...
static void logRE(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logER(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outE32(op, out);
...
static void logRE8(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logRR8(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logRE16(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logRR16(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logR(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outR32(op->reg, out);
...
static void logE(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (inst->width==32) {
        outE32(op, out);
...
static void logS(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logSR(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logRS(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logSE(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logES(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logName(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
}

static void logCsEip(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logMM(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logME(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logMR(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logM(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logRM(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logEM(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logXmmXmm(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    outXMM(op->reg, out);
    out.append(",");
...
static void logXmmI(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logXmmE(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
...
static void logRXmm(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logEXmm(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
    out.append(" ");
    if (op->ea16) {
        outE16(op, out);
...
static void logXmmR(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logXmmM(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}

static void logMXmm(const LogInstruction* inst, DecodedOp* op, BString& out) {
    out.append(inst->name);
}
...
void decodeEa16(DecodeData* data, DecodedOp* op, U8 rm) {
    if (rm<0x40) {
        ...
        case 0x06: op->base=data->ds; op->rm=regZero;op->data.disp = (S16)data->fetch16(); op->sibIndex=regZero; op->sibIndex=regZero; break;
        case 0x07: op->base=data->ds; op->rm=regBX; op->sibIndex=regZero; break;
        }
    } else {
        if (rm<0x80) {
            op->data.disp = (S8)data->fetch8();
        } else {
            op->data.disp = (S16)data->fetch16();
        }
        switch (rm & 7) {
        case 0x00: op->base=data->ds; op->rm=regBX; op->sibIndex=regSI; break;
        case 0x01: op->base=data->ds; op->rm=regBX; op->sibIndex=regDI; break;
...
U32 SibE2Reg[8] = {regAX, regCX, regDX, regBX, regZero, regBP, regSI, regDI};
 ...
 void Sib0(DecodeData* data, DecodedOp* op) {
    ...
    case 5:
        op->base = data->ds; op->rm=regZero;op->data.disp = data->fetch32();break;
    case 6:
...
void decodeEa32(DecodeData* data, DecodedOp* op, U8 rm) {
    ...
    if (rm<0x40) {
        ...
        case 0x05: op->base=data->ds; op->rm = regZero; op->data.disp = data->fetch32(); break;
...
const Decode* const decoder[] = {
    ...
    nullptr, nullptr, nullptr, &decodeUD2, nullptr, nullptr, nullptr, nullptr,
    // 0x310
...
bool DecodedOp::isBranch() {
    return instructionInfo[inst].branch != 0;
}
...
U32 DecodedOp::getNeededFlagsAfter(U32 flags, U32 depth) {
    if (instructionInfo[inst].branch & DECODE_BRANCH_1) {
        bool conditionalBranch = (instructionInfo[inst].branch & DECODE_BRANCH_2) != 0;
        if (!conditionalBranch) {
            if (data.nextJump && *(data.nextJump)) {
                return (*(data.nextJump))->getNeededFlags(flags);
            }
            return flags;
        } else {
            if (data.nextJump && *(data.nextJump)) {
                U32 needsToSet1 = next->getNeededFlags(flags);
                U32 needsToSet2 = (*(data.nextJump))->getNeededFlags(flags);
                return needsToSet1 | needsToSet2;
            }
            return flags;
        }
    }
    return next->getNeededFlags(flags);
}
...
U32 DecodedOp::getNeededFlags(U32 flags, U32 depth) {
    ...
    while (n && flags && depth) {
        if (instructionInfo[n->inst].branch & DECODE_BRANCH_NO_CACHE) {
            // RTC will return flags in a retn instruction
            return flags;
        }
        ...
        if (instructionInfo[n->inst].flagsUsed & flags) {
            ...
            if (flags && n->next) {
                result |= getNeededFlagsAfter(flags, depth);
            }
            return result;
        }
        ...
        if (instructionInfo[n->inst].branch & DECODE_BRANCH_1) {
            bool conditionalBranch = (instructionInfo[n->inst].branch & DECODE_BRANCH_2) != 0;
            if (!conditionalBranch) {
                if (n->data.nextJump) {
                    n = *(n->data.nextJump);
                    depth--;
...
static void translateToLockInstruction(DecodedOp* op) {
#define INIT_CPU_LOCK(e, f) case e: op->inst = e##_Lock; break;
    switch (op->inst) {
...
BString DecodedOp::toString() {
    ...
    if (instructionLog[this->inst].imm) {
        ...
        case -16:
            out.append((S32)((S16)((U16)this->imm)), 16);
            break;
        case -32:
            out.append(this->imm, 16);
            break;
        case -8:
            out.append((S32)((S8)((U8)this->imm)), 16);
            break;
        default:
            out.append(this->imm, 16);
            break;
...
void DecodedOp::log(CPU* cpu) {
    ...
    if (cpu->logFile.isOpen() && this->inst >= 0 && this->inst < None) {
        ...
        cpu->logFile.write(toString().c_str());
