...
enum class Msg {
    ...
    CONTAINER_VIEW_DXVK_LABEL,
    CONTAINER_VIEW_DXVK_HELP,
    CONTAINER_VIEW_DISABLE_HIDE_CURSOR_LABEL,
    CONTAINER_VIEW_DISABLE_HIDE_CURSOR_HELP,
    CONTAINER_VIEW_FORCE_RELATIVE_MOUSE_LABEL,
    CONTAINER_VIEW_FORCE_RELATIVE_MOUSE_HELP,
